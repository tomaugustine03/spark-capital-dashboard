...
export default function MicrolendingDashboard() {
    ...
    const COLORS = ['#0d4b9e', '#1a73e8', '#4285f4', '#5e97f6', '#8ab4f8'];
        ...
        <div className="flex flex-col h-screen bg-gray-50 text-gray-800">
            <div className="flex flex-1 overflow-hidden">
                        ...
                        {isSidebarOpen ? (
                            <>
                                <div className="flex items-center">
                                    <div className="bg-blue-600 w-9 h-9 rounded-md flex items-center justify-center text-white font-bold">MSC</div>
                                    <span className="ml-2 font-semibold text-lg">Main Street Capital</span>
                                </div>
                            ...
                            <>
                                <div className="bg-blue-600 w-8 h-8 rounded-md flex items-center justify-center text-white font-bold">MSC</div>
                                <button onClick={toggleSidebar} className="text-gray-400 hover:text-white">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="bg-white p-4 rounded-lg shadow">
                                ...
                                <div className="space-y-3">
                                    {notifications.map((notification) => (
                                        <div key={notification.id} className="p-3 rounded-lg bg-gray-50 border-l-4 border-blue-600">
                    ...
                    {/* Footer */}
                    <footer className="bg-white p-4 border-t text-sm text-gray-500 mt-auto w-full">
                        <div className="flex flex-col md:flex-row justify-between items-center w-full">
                            <div className="mb-2 md:mb-0 text-center md:text-left">© 2025 Main Street Capital. All rights reserved.</div>
